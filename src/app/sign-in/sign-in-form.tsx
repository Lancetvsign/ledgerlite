 ...
 *
 * Demonstration UI for LL-010 and the E2E login path. In invitation mode (LL-090)
 * there is no "create account" here at all: accounts are created from a join link.
 */
export function SignInForm({ signUpMode }: { signUpMode: 'open' | 'invitation' }) {
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-sm flex-col justify-center gap-4 p-8">
      ...
      {signUpMode === 'open' ? (
        ...
        <p className="text-sm text-neutral-500" data-testid="invitation-only">
          Sign-up is by invitation. Ask your company owner for an invitation link.
        </p>
      )}
    </main>
  );
